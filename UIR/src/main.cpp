НЕЛЬЗЯ докер ни в коем случае
мы дойдем до шага когда надо запустить скрипт в конетйнере ты мне скажешь что все готово и скинешь команду чтобы я запустил у себя в терминале

Все должно быть супер готово 

так что дай мне список команд чтобы перезапустить прибить все что осталось от пролшлого и заново хзапустить скрипт в конейтне
